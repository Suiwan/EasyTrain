...
def generated_train():
	model = nn()
	model.load_tab_data(r'D:\workspace\XEdu\utils\dataset\basenn\iris_training.csv',y_type='long',batch_size=32)
	model.save_fold = r'D:\workspace\XEdu\my_checkpoints\basenn_20231110_183945'
	model.set_seed(42)
