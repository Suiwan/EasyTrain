...
def generated_train():
	...
	model.save_fold = r'D:\workspace\XEdu\my_checkpoints\basenn_20231121_100724'
	model.set_seed(42)
	model.add(optimizer='SGD')
	model.add(layer='linear',size=(2, 10),activation='relu')
	model.add(layer='linear',size=(10, 20),activation='relu')
	model.add(layer='linear',size=(20, 1),activation='softmax')
