...
global_varibles = {
    ...
    "model": "LeNet",
    "dataset": "hand_gray",
    "dataset_path": os.path.abspath(os.path.dirname(os.path.dirname(__file__))) + "\\dataset\\cls\\hand_gray",
    "checkpoints_path": os.path.abspath(os.path.dirname(os.path.dirname(__file__))) + "\\EasyDL2.0\\checkpoints",
    "lr": 0.01,
    "epoch": 10,
    "batch_size": None,
    "class_num":3,
...
def get_all_dataset():
    res = {}
    # 获取cls文件夹下的所有文件夹
    cls_dataset_path = os.path.abspath(os.path.dirname(os.path.dirname(__file__))) + "\\dataset\\cls"
    ...
    # 获取det文件夹下的所有文件夹
    det_dataset_path = os.path.abspath(os.path.dirname(os.path.dirname(__file__))) + "\\dataset\\det"
...
def update_dataset_path():
    global_varibles["dataset_path"] = os.path.abspath(os.path.dirname(os.path.dirname(__file__))) + "\\dataset\\cls\\" + global_varibles["dataset"]
